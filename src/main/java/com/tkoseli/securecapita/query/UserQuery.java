package com.tkoseli.securecapita.query;

public class UserQuery {
    public static final String INSER_USER_QUERY = "INSERT INTO Users (first_name,last_name, email, password) VALUES (:firstName, :lastName, :email, :password)";
