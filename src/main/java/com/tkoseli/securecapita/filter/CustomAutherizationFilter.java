package com.tkoseli.securecapita.filter;
...
import static com.tkoseli.securecapita.utils.ExceptionUtils.processError;
...
public class CustomAutherizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        try {
            ...
            if (tokenProvider.isTokenValid(values.get(TOKEN_KEY), token)) {
